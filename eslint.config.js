...
const getTsNamingConventionRule = ({ isTsx }) => ({
  '@typescript-eslint/naming-convention': [
    ...
    {
      selector: 'default',
      format: ['camelCase', ...(isTsx ? ['StrictPascalCase'] : [])],
      leadingUnderscore: 'forbid',
      trailingUnderscore: 'forbid',
    },
    {
      selector: 'variable',
      format: ['camelCase', 'UPPER_CASE', ...(isTsx ? ['StrictPascalCase'] : [])],
      modifiers: ['const'],
...
const baseRules = {
  ...
  // TODO: temporary disabled, till will have a time for a components refactoring
  // complexity: [2, 15],
  'max-depth': [2, 4],
...
const typescriptRules = {
  ...
  // typescript-eslint/strict rules, default error
